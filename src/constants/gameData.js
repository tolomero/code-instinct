export const PLAYER_CHARACTERS = [
  { 
    id: "dev", 
    name: "Developer", 
    image: "https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExMGNmMDg2dzhtcWptaWp1eXY5MmtyeXNqM3E3YzN5amI1b3phb2cxZSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/SUEXjIV3brSQrMInVX/giphy.gif",
    attackImage: "https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3MndnampoMDlhZ3Y0b2hmd3AwbWtqNmx5MDI0MG5vdGJmaDBqZXU5NCZlcD12MV9zdGlja2Vyc19zZWFyY2gmY3Q9cw/XDcYw8gtUipVNF0ZbB/giphy.gif",
    idleFlip: true,
    attackFlip: true 
  },
  { 
    id: "naruto", 
    name: "Naruto", 
    image: "https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3bmp1bWE1dTFtc29hZ2o3NGtuM3FuN3c2bzlhaHR3ajF5eHZiMmx6OSZlcD12MV9zdGlja2Vyc19yZWxhdGVkJmN0PXM/J6VWOd9svfh5KESnP9/giphy.gif",
    attackImage: "https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3bmp1bWE1dTFtc29hZ2o3NGtuM3FuN3c2bzlhaHR3ajF5eHZiMmx6OSZlcD12MV9zdGlja2Vyc19yZWxhdGVkJmN0PXM/fvGZ6FVc1hYrdQBjo9/giphy.gif",
    idleFlip: false,
    attackFlip: false
  },
  { 
    id: "pikachu", 
    name: "Pikachu", 
    image: "https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3bWVleXZjZDRhM211cnJ2amhjdHU2NXNlanl5aWptMW03dWp2enNjNiZlcD12MV9zdGlja2Vyc19yZWxhdGVkJmN0PXM/FMnVZzDALopvG/giphy.gif",
    attackImage: "https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExZnlwYjExeWU2cHRucDlpcnZhcjJqeXJ6bW1vcTgxczB0eXl4N2ticCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/RLmqruN8pfVWspnJrn/giphy.gif",
    idleFlip: true,
    attackFlip: false
  },
  { 
    id: "amongus", 
    name: "Among Us", 
    image: "https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3bmp1bWE1dTFtc29hZ2o3NGtuM3FuN3c2bzlhaHR3ajF5eHZiMmx6OSZlcD12MV9zdGlja2Vyc19yZWxhdGVkJmN0PXM/z4zzec8rwzIacTQ3wb/giphy.gif",
    attackImage: "https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3bmp1bWE1dTFtc29hZ2o3NGtuM3FuN3c2bzlhaHR3ajF5eHZiMmx6OSZlcD12MV9zdGlja2Vyc19yZWxhdGVkJmN0PXM/Vpb3ucv121hhXg72Wg/giphy.gif",
    idleFlip: false,
    attackFlip: false
  },
  {
...
export const LORE_CHARACTERS = [
  { name: "Johnny Cage",
    avatar: "🧘", bio: "Purificando el código fuente.",
    combatImage: "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExbjNteTA2M3ZibXVmNndvOGczNng4a3d2NXJvY3oxanRwczRoMG9rYyZlcD12MV9zdGlja2Vyc19zZWFyY2gmY3Q9cw/UUyv63z5Uc9HOmhtcj/giphy.gif",
    category: "basico" },
  { 
    name: "Sabrewulf", 
    avatar: "🐺", 
  ...
  { 
    name: "Glacius", 
    avatar: "🧊", 
    combatImage: "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExbjNteTA2M3ZibXVmNndvOGczNng4a3d2NXJvY3oxanRwczRoMG9rYyZlcD12MV9zdGlja2Vyc19zZWFyY2gmY3Q9cw/JtGzDCMTccqmBEQzkA/giphy.gif",
    bio: "Congelando bugs en runtime.", 
    category: "intermedio" 
  },
  { name: "Fulgore", 
    avatar: "🤖", 
    ...
    bio: "Protocolo de combate Ultratech activo.", 
    category: "intermedio" },
  { 
    name: "Cinder", 
    avatar: "🔥", 
    combatImage: "https://www.fightersgeneration.com/nz2/char/scorpion-mk-hd-sprite-cancelled-project.gif",
    bio: "Quemando scripts ineficientes.", 
    category: "intermedio" 
  }
];
...
export const QUESTION_MOCKS = {
  ...
  fibonacci_minions: [
    ...
    { type: 'code', text: "Completa: fib[2] = fib[1] + fib[___]", solution: "0", damage: 55, lore: "Recalculando secuencia base." },
    { type: 'choice', text: "¿Cuál es el tercer número de Fibonacci (0,1,1...)?", options: ["0", "1", "2", "3"], correct: 1, damage: 45, solution: "1" },
    { type: 'code', text: "Para crear el array inicial: const fib = [0, ___];", solution: "1", damage: 55, lore: "Inicializando sistema." },
    { type: 'choice', text: "¿Cuál es fib(6)?", options: ["5", "8", "13", "21"], correct: 1, damage: 50, solution: "8" },
    { type: 'code', text: "Dentro del for, ¿qué usamos para sumar los dos últimos? fib[i-1] + fib[i-___]", solution: "2", damage: 55, lore: "Cálculo recursivo." },

  { type: 'choice', text: "¿Cuál es el valor de fib(2)?", options: ["0", "1", "2", "3"], correct: 1, damage: 45, solution: "1" },
  { type: 'code', text: "Para detener el bucle al llegar a n: for(let i = 2; i < ___; i++)", solution: "n", damage: 55, lore: "Controlando límites." },
  { type: 'choice', text: "¿Cuál es el resultado de fib(7)?", options: ["8", "13", "21", "34"], correct: 1, damage: 50, solution: "13" },
  { type: 'code', text: "Para obtener el último valor: fib[fib.length - ___]", solution: "1", damage: 55, lore: "Extracción final." },
  { type: 'choice', text: "¿Cuál es fib(4)?", options: ["2", "3", "4", "5"], correct: 1, damage: 45, solution: "3" },

  { type: 'code', text: "Para empezar el bucle correctamente: for(let i = ___; i < n; i++)", solution: "2", damage: 55, lore: "Secuencia alineada." },
  { type: 'choice', text: "¿Cuál es el valor de fib(1)?", options: ["0", "1", "2", "3"], correct: 1, damage: 40, solution: "1" },
  { type: 'code', text: "Para crear la variable resultado: let res = ___;", solution: "[]", damage: 55, lore: "Contenedor preparado." },
  { type: 'choice', text: "¿Cuál es fib(5)?", options: ["3", "5", "8", "13"], correct: 1, damage: 50, solution: "5" },
  { type: 'code', text: "Para añadir el siguiente número: res.___(res[i-1] + res[i-2]);", solution: "push", damage: 60, lore: "Escribiendo memoria." },

  { type: 'choice', text: "¿Cuál es fib(8)?", options: ["13", "21", "34", "55"], correct: 1, damage: 50, solution: "21" },
  { type: 'code', text: "Para leer el antepenúltimo valor: res[res.length - ___]", solution: "3", damage: 55, lore: "Memoria profunda." },
  { type: 'choice', text: "¿Cuál es fib(3)?", options: ["1", "2", "3", "4"], correct: 0, damage: 45, solution: "1" },
  { type: 'code', text: "Condición para continuar: while(res.length < ___)", solution: "n", damage: 55, lore: "Ejecución persistente." },
  { type: 'choice', text: "¿Cuál es fib(9)?", options: ["21", "34", "55", "89"], correct: 1, damage: 50, solution: "34" }
  ],
  primo_minions: [
    { type: 'choice', text: "¿Qué es un número primo?", options: ["Solo divisible por 1 y sí mismo", "Múltiplo de 2", "Termina en impar", "Mayor que 100"], correct: 0, damage: 50, solution: "Divisible por 1 y sí mismo" },
    { type: 'choice', text: "¿Cuál es el único número par que es primo?", options: ["0", "2", "4", "6"], correct: 1, damage: 45, solution: "2" },
    { type: 'choice', text: "¿Es the número 1 un número primo?", options: ["Sí", "No", "A veces", "Solo en JS"], correct: 1, damage: 45, solution: "No" },
    { type: 'choice', text: "¿Cuál es el siguiente primo después del 7?", options: ["9", "10", "11", "13"], correct: 2, damage: 50, solution: "11" },
    { type: 'choice', text: "¿Cuántos divisores tiene exactamente un número primo?", options: ["1", "2", "Infinitos", "Ninguno"], correct: 1, damage: 50, solution: "2" },
    { type: 'code', text: "Para saber si 'n' es divisible por 'i': n % i === ___", solution: "0", damage: 55, lore: "Buscando divisores." },
    { type: 'choice', text: "¿Es 27 un número primo?", options: ["Sí, es impar", "No, es 3x9", "Sí, es primo", "No sé"], correct: 1, damage: 50, solution: "No (3x9)" },
    { type: 'code', text: "Si encontramos un divisor antes de llegar a n, el número ___ primo.", solution: "no es", damage: 60, lore: "Validación lógica." },
    { type: 'choice', text: "¿Cuál es el primo más cercano a 20?", options: ["17", "19", "21", "23"], correct: 1, damage: 50, solution: "19" },
    { type: 'code', text: "Bucle para buscar divisores de 'n': for(let i=2; i < ___; i++)", solution: "n", damage: 55, lore: "Escaneo de rango." },
    { type: 'choice', text: "¿Es 97 un número primo?", options: ["Sí", "No", "Solo los martes", "Es compuesto"], correct: 0, damage: 60, solution: "Sí" }
  ],
  poligono_minions: [
    { type: 'choice', text: "¿Cuál es el área de un cuadrado de lado 5?", options: ["10", "20", "25", "50"], correct: 2, damage: 50, solution: "25" },
    { type: 'choice', text: "¿Fórmula del área de un triángulo?", options: ["base * altura", "(base * altura) / 2", "lado * lado", "base + altura"], correct: 1, damage: 50, solution: "(b*h)/2" },
    { type: 'choice', text: "¿Fórmula del área de un rectángulo?", options: ["base * altura", "lado * 4", "base / altura", "lado ** 2"], correct: 0, damage: 50, solution: "base * altura" },
    { type: 'choice', text: "¿Cuántos lados tiene un polígono de tipo 'Cuadrado'?", options: ["3", "4", "5", "6"], correct: 1, damage: 40, solution: "4" },
    { type: 'code', text: "Calculando cuadrado: return lado * ___", solution: "lado", damage: 55, lore: "Cálculo de superficie." },
    { type: 'choice', text: "¿Qué devuelve el área de un triángulo con base 10 y altura 5?", options: ["50", "25", "15", "100"], correct: 1, damage: 50, solution: "25" },
    { type: 'code', text: "En un switch para polígonos: case '___': return b * h;", solution: "rectangulo", damage: 60, lore: "Selección de lógica." },
    { type: 'choice', text: "¿El área puede ser un número negativo?", options: ["Sí", "No", "Solo en vectores", "En JS sí"], correct: 1, damage: 45, solution: "No" },
    { type: 'code', text: "Para un triángulo de base 'b' y altura 'h': (b * h) / ___", solution: "2", damage: 55, lore: "División geométrica." },
    { type: 'choice', text: "¿Qué unidad suele tener el área?", options: ["Metros", "Unidades cuadradas", "Litros", "Kilogramos"], correct: 1, damage: 45, solution: "Unidades cuadradas" }
  ]
};
...
export const BOSS_CHARACTERS = [
  { 
    ...
    prelude: [
      ...
      { type: 'choice', text: "¿Qué valor devuelve 20 % 4?", options: ["5", "0", "4", "1"], correct: 1, damage: 50, solution: "0" },
  { type: 'choice', text: "¿Cómo verificas si un número NO es múltiplo de 2?", options: ["num % 2 === 0", "num % 2 !== 0", "num / 2 === 1", "num % 1 === 0"], correct: 1, damage: 50, solution: "num % 2 !== 0" },
  { type: 'choice', text: "Si n = 22, ¿cuál es el resultado de n % 5?", options: ["2", "3", "4", "5"], correct: 0, damage: 50, solution: "2" },
  { type: 'choice', text: "¿Qué condición detecta múltiplos de 7?", options: ["n % 7 === 0", "n / 7 === 0", "n % 7 === 1", "n * 7 === 0"], correct: 0, damage: 55, solution: "n % 7 === 0" },
  { type: 'choice', text: "Si x % 4 === 3, ¿cuál es el residuo?", options: ["4", "1", "3", "0"], correct: 2, damage: 50, solution: "3" }
    ],
    ...
    partialFatalityHint: "Usa un bucle for de 1 a 15 e inspecciona el residuo con %. \n\nfor(let i=1; i<=15; i++){\n  if(i % 3 === 0 && i % 5 === 0) console.log('FizzBuzz');\n  else if(i % 3 === 0) ...\n}"
  },
  { 
    id: "spinal",
    name: "SPINAL", 
    ...
    prelude: [
      ...
      { type: 'choice', text: "¿Qué método convierte un array de letras en un string?", options: [".split('')", ".join('')", ".slice()", ".map()"], correct: 1, damage: 50, solution: ".join('')" },
  { type: 'choice', text: "¿Qué devuelve 'listen'.split('').sort().join('')?", options: ["listen", "eilnst", "tinsel", "silent"], correct: 1, damage: 55, solution: "eilnst" },
  { type: 'choice', text: "¿Qué método permite comparar strings ignorando mayúsculas?", options: [".toLowerCase()", ".capitalize()", ".upper()", ".format()"], correct: 0, damage: 50, solution: ".toLowerCase()" },
  { type: 'choice', text: "¿Qué condición debe cumplirse para que dos palabras sean anagramas?", options: ["Misma longitud", "Mismos caracteres ordenados", "Empiecen igual", "Terminen igual"], correct: 1, damage: 60, solution: "Mismos caracteres ordenados" },
  { type: 'choice', text: "¿Qué devuelve 'roma'.split('').sort().join('') === 'amor'.split('').sort().join('')?", options: ["true", "false", "null", "error"], correct: 0, damage: 60, solution: "true" }
    ],
    ...
    partialFatalityHint: "Divide el string, ordénalo y vuelve a unirlo para comparar.\n\nconst s1 = str1.split('').sort().join('');\nconst s2 = str2.split('').sort().join('');\nreturn s1 === s2;"
  },
  { 
    id: "fulgore",
    name: "FULGORE", 
    ...
    prelude: [
      ...
      { type: 'choice', text: "¿Qué número sigue en la serie: 1, 1, 2, 3, 5, 8, 13?", options: ["18", "21", "34", "20"], correct: 1, damage: 55, solution: "21" },
  { type: 'choice', text: "¿Cuál es el valor de Fibonacci(10)?", options: ["34", "55", "89", "144"], correct: 1, damage: 60, solution: "55" },
  { type: 'choice', text: "Si fib(4) = 3 y fib(5) = 5, ¿cuánto es fib(6)?", options: ["5", "8", "13", "21"], correct: 1, damage: 55, solution: "8" },
  { type: 'choice', text: "¿Cuál es el resultado de la razón fib(9) / fib(8) aproximadamente?", options: ["1.2", "1.4", "1.6", "2"], correct: 2, damage: 65, solution: "1.6" },
  { type: 'choice', text: "¿Qué caso base se usa en la versión recursiva de Fibonacci?", options: ["n <= 2", "n === 0 || n === 1", "n > 2", "n === -1"], correct: 1, damage: 60, solution: "n === 0 || n === 1" }
    ],
    ...
    partialFatalityHint: "Calcula el siguiente número sumando los dos anteriores.\n\nconst res = [0, 1];\nfor(let i=2; i<50; i++){\n  res.push(res[i-1] + res[i-2]);\n}"
  },
  { 
    id: "johnny",
    name: "JOHNNY CAGE", 
    avatar: "😎",
    selectionImage: "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExbjNteTA2M3ZibXVmNndvOGczNng4a3d2NXJvY3oxanRwczRoMG9rYyZlcD12MV9zdGlja2Vyc19zZWFyY2gmY3Q9cw/UUyv63z5Uc9HOmhtcj/giphy.gif",
    combatImage: "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExbjNteTA2M3ZibXVmNndvOGczNng4a3d2NXJvY3oxanRwczRoMG9rYyZlcD12MV9zdGlja2Vyc19zZWFyY2gmY3Q9cw/UUyv63z5Uc9HOmhtcj/giphy.gif",
    bio: "Estrella de Cine. Objetivo: Números Primos.", 
    isFinal: true,
    logicType: "primo",
    prelude: [
      { type: 'choice', text: "¿Cuál de estos es un número primo?", options: ["4", "9", "13", "25"], correct: 2, damage: 50, solution: "13" },
      { type: 'choice', text: "¿Cuántos divisores tiene un primo?", options: ["1", "2", "3", "Muchos"], correct: 1, damage: 50, solution: "2" },
      { type: 'choice', text: "¿Es 51 un número primo?", options: ["Sí", "No (17x3)", "Tal vez", "Solo en Mortal Kombat"], correct: 1, damage: 50, solution: "No" },
      { type: 'choice', text: "¿Cuál es el primer número primo?", options: ["0", "1", "2", "3"], correct: 2, damage: 50, solution: "2" },
      { type: 'choice', text: "Para saber si N es primo, probamos divisores hasta...", options: ["N/2", "Raíz de N", "Infinity", "N-1"], correct: 1, damage: 60, solution: "Raíz de N" }
    ],
    fatality: { type: 'code', text: "¡FATALITY! NÚMEROS PRIMOS: Escribe un programa que compruebe si un número es primo e imprime los primos del 1 al 100.", solution: "primo", damage: 300 },
    partialFatalityHint: "Usa un bucle anidado o una función auxiliar isPrime(n). \n\nfunction isPrime(n) {\n  if(n < 2) return false;\n  for(let i=2; i<n; i++) if(n % i === 0) return false;\n  return true;\n}"
  },
  { 
    id: "cinder_boss",
    name: "CINDER", 
    avatar: "🔥",
    selectionImage: "https://www.fightersgeneration.com/nz2/char/scorpion-mk-hd-sprite-cancelled-project.gif",
    combatImage: "https://www.fightersgeneration.com/nz2/char/scorpion-mk-hd-sprite-cancelled-project.gif",
    bio: "Fuego Eterno. Reto: Geometría JS.", 
    isFinal: true,
    logicType: "poligono",
    prelude: [
      { type: 'choice', text: "¿Área de un triángulo de base 4 y altura 6?", options: ["24", "12", "10", "46"], correct: 1, damage: 50, solution: "12" },
      { type: 'choice', text: "¿Qué parámetro necesita un Cuadrado?", options: ["Base y Altura", "Solo un Lado", "Radio", "Ángulo"], correct: 1, damage: 50, solution: "Lado" },
      { type: 'choice', text: "¿Área de un rectángulo 5x10?", options: ["15", "25", "50", "100"], correct: 2, damage: 50, solution: "50" },
      { type: 'choice', text: "En un polígono regular, ¿qué usamos para el área?", options: ["Apotema", "Color", "Nombre", "ID"], correct: 0, damage: 50, solution: "Apotema" },
      { type: 'choice', text: "Formula del área del círculo (aunque no se use hoy):", options: ["PI * r", "2 * PI * r", "PI * r^2", "Lado^2"], correct: 2, damage: 60, solution: "PI * r^2" }
    ],
    fatality: { type: 'code', text: "¡FATALITY! ÁREA DE POLÍGONOS: Crea una función que calcule el área de un Triángulo, Cuadrado o Rectángulo según el tipo recibido.", solution: "poligono", damage: 300 },
    partialFatalityHint: "Usa un switch o un if/else para el 'type'. \n\nfunction area(poly) {\n  if(poly.type === 'triangulo') return (poly.b * poly.h) / 2;\n  if(poly.type === 'cuadrado') return poly.l * poly.l;\n  ...\n}"
  }
];
